...
/* harmony import */ var _env_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(543);
/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(685);
...
async function createFullDid() {
    await _kiltprotocol_sdk_js__WEBPACK_IMPORTED_MODULE_0__.init({
        address: _env_json__WEBPACK_IMPORTED_MODULE_3__/* .WSS_ADDRESS */ .wJ
    });
    const { api  } = await _kiltprotocol_sdk_js__WEBPACK_IMPORTED_MODULE_0__.connect();
    const mnemonic = _env_json__WEBPACK_IMPORTED_MODULE_3__/* .ATTESTER_MNEMONIC */ .tx;
...
module.exports = JSON.parse('{"wJ":"wss://peregrine.kilt.io/parachain-public-ws","tx":"trade silver faith garment ladder collect midnight neutral cool invite trash fluid","Mg":"did:kilt:4qgyzwgCB8GErUyzqGy9QNVJfqBT8nJnik4CGtM4s9dNpUsm"}');
